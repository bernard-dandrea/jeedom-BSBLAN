...
<div class="row row-overflow">
  ...
  <div class="col-xs-12 eqLogicThumbnailDisplay">
    ...
    <legend><i class="fas fa-table"></i> {{Mes BSBLAN}}</legend>
    <?php
    if (count($eqLogics) == 0) {
      echo '<br><div class="text-center" style="font-size:1.2em;font-weight:bold;">{{Aucun équipement BSBLAN trouvé, cliquer sur "Ajouter" pour commencer}}</div>';
    } else {
      // Champ de recherche
      ...
      foreach ($eqLogics as $eqLogic) {
        ...
        $file = 'plugins/BSBLAN/plugin_info/' . $eqLogic->getConfiguration('icon') . '.png';
          ...
          <fieldset>
            ...
            <div class="col-lg-8">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label">{{Nom du BSBLAN}}</label>
                <div class="col-sm-6">
              ...
              <div class="form-group ">
                <label class="col-sm-4 control-label">{{Nombre d'essais de récupération d'un paramètre}}</label>
                <div class="col-sm-6">
                  <input type="number" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="retry">
                </div>
              </div>
              <div class="form-group ">
                <label class="col-sm-4 control-label">{{Nombre d'erreurs avant d'abandonner l'interrogation de l'équipement (défaut 3)}}</label>
                <div class="col-sm-6">
                  <input type="number" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="max_errors">
                </div>
              </div>
              <div class="form-group ">
...
<?php
include_file('desktop', 'BSBLAN', 'js', 'BSBLAN');
